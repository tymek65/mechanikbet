...
const pp = () => {
  return (
    <>
      <Head>
        <title>Polityka Prywatności | mechanikBET</title>
      </Head>
      <article>
        ...
        <p>
          ...
          <a href="https://mechanikbet.sraka.online/regulamin">
            Regulaminu Serwisu
          </a>
        ...
        <ul>
          <li>
            <p>
              ...
              "mechanikbet.sraka.online" działający pod adresem
              https://mechanikbet.sraka.online
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              osoba fizyczna "Jakub Tymowski" zamieszkała w Tarnowskich Górach,
        ...
        <p>
          ...
          >
            PayPro SA. Wybrane dane niezbędne do realizacji transakcji są
            następnie przekazywane przez ten podmiot Administratorowi.
            Przekazanie danych reguluje umowa zawarta pomiędzy Administratorem a
            Usługodawcą.
          </a>
        </p>
        <br />
        ...
        <ul>
          <li>
            <p>
              <strong>Adres poczty elektronicznej</strong> - tymek1313@gmail.com
            </p>
          </li>
          <li>
            <p>
              <strong>Połączenie telefoniczne</strong> - +48 695 445 351
            </p>
          </li>
          <li>
            <p>
